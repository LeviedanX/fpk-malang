<div class="grid gap-6 lg:grid-cols-3">
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-2">
            ...
            <a href="{{ route('admin.articles.index') }}" class="rounded-md border border-slate-300 px-4 py-2.5 text-center font-medium text-slate-600 hover:bg-slate-50">Batal</a>
        </div>
    </div>
</div>
