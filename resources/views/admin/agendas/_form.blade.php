<div class="grid gap-6 lg:grid-cols-3">
    ...
    <div class="space-y-6">
        <x-admin.card title="Status">
            <div class="space-y-4">
                <x-form.select name="event_status" label="Status Acara" :options="\App\Enums\AgendaStatus::options()" :selected="$agenda->exists ? $agenda->effectiveEventStatus()->value : 'scheduled'" required hint="Terjadwal, Berlangsung, dan Selesai menyesuaikan waktu acara. Pilih Dibatalkan secara manual; Selesai manual berlaku untuk agenda tanpa waktu selesai." />
