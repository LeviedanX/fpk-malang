...
-- Dumping database structure for zzk_web
CREATE DATABASE IF NOT EXISTS `zzk_web` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `zzk_web`;

-- Dumping structure for table zzk_web.admins
...
-- Dumping data for table zzk_web.admins: ~1 rows (approximately)
...
-- Dumping structure for table zzk_web.articles
...
-- Dumping data for table zzk_web.articles: ~3 rows (approximately)
...
-- Dumping structure for table zzk_web.article_categories
...
-- Dumping data for table zzk_web.article_categories: ~7 rows (approximately)
...
-- Dumping structure for table zzk_web.cache
...
-- Dumping data for table zzk_web.cache: ~1 rows (approximately)
...
-- Dumping structure for table zzk_web.cache_locks
...
-- Dumping data for table zzk_web.cache_locks: ~0 rows (approximately)

-- Dumping structure for table zzk_web.failed_jobs
...
-- Dumping data for table zzk_web.failed_jobs: ~0 rows (approximately)

-- Dumping structure for table zzk_web.faqs
...
-- Dumping data for table zzk_web.faqs: ~5 rows (approximately)
...
-- Dumping structure for table zzk_web.galleries
...
-- Dumping data for table zzk_web.galleries: ~0 rows (approximately)

-- Dumping structure for table zzk_web.hero_sections
...
-- Dumping data for table zzk_web.hero_sections: ~1 rows (approximately)
...
-- Dumping structure for table zzk_web.jobs
...
-- Dumping data for table zzk_web.jobs: ~0 rows (approximately)

-- Dumping structure for table zzk_web.job_batches
...
-- Dumping data for table zzk_web.job_batches: ~0 rows (approximately)

-- Dumping structure for table zzk_web.messages
...
-- Dumping data for table zzk_web.messages: ~0 rows (approximately)

-- Dumping structure for table zzk_web.migrations
...
-- Dumping data for table zzk_web.migrations: ~9 rows (approximately)
...
-- Dumping structure for table zzk_web.password_reset_tokens
...
-- Dumping data for table zzk_web.password_reset_tokens: ~0 rows (approximately)

-- Dumping structure for table zzk_web.process_steps
...
-- Dumping data for table zzk_web.process_steps: ~6 rows (approximately)
...
-- Dumping structure for table zzk_web.seo_settings
...
-- Dumping data for table zzk_web.seo_settings: ~1 rows (approximately)
...
-- Dumping structure for table zzk_web.services
...
-- Dumping data for table zzk_web.services: ~8 rows (approximately)
...
-- Dumping structure for table zzk_web.sessions
...
-- Dumping data for table zzk_web.sessions: ~0 rows (approximately)

-- Dumping structure for table zzk_web.site_settings
...
-- Dumping data for table zzk_web.site_settings: ~1 rows (approximately)
...
-- Dumping structure for table zzk_web.users
...
-- Dumping data for table zzk_web.users: ~0 rows (approximately)
